...
CREATE OR REPLACE FUNCTION mediaDiasSuministro(num IN varchar2) RETURN number is

mediaDias number := 0;
    
BEGIN

SELECT AVG(DIASSUM) INTO mediaDias FROM PRECIOSUM WHERE NUMPIEZA = num;
return mediaDias;
...
dbms_output.put_line(mediaDiasSuministro('DK144-0002-P'));
dbms_output.put_line(mediaDiasSuministro('M-0002-C'));
...
CREATE OR REPLACE TRIGGER actualizarInventario AFTER INSERT OR UPDATE on LINPED FOR EACH ROW declare
    
BEGIN

UPDATE INVENTARIO SET CANTDISPONIBLE = :NEW.CANTRECIBIDA+CANTDISPONIBLE WHERE NUMPIEZA = :NEW.NUMPIEZA;

END;

INSERT INTO LINPED VALUES(3,55,'DD-0001-210',146,15,TO_DATE('17/10/1992','DD/MM/YYYY'),15);
SELECT CANTDISPONIBLE FROM INVENTARIO WHERE NUMPIEZA = 'DD-0001-210';
INSERT INTO LINPED VALUES(3,56,'DD-0001-210',146,15,TO_DATE('17/10/1992','DD/MM/YYYY'),15);
SELECT CANTDISPONIBLE FROM INVENTARIO WHERE NUMPIEZA = 'DD-0001-210';
